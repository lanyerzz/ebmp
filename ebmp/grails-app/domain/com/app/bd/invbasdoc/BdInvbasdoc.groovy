...
class BdInvbasdoc {
    ...
    BdCorp  pkCorp  //公司主键
    BdInvcl  pkInvcl  //存货分类主键
    BdMeasdoc  bdmeasdoc //主计量单位主键
    BdMeasdoc  bdmeasdoc1  //销售默认单位
    BdMeasdoc  bdmeasdoc2 //采购默认单位
    BdMeasdoc  bdmeasdoc3  //库存默认单位
    BdMeasdoc  bdmeasdoc4 //生产默认单位
    BdMeasdoc  bdmeasdoc5  //零售计量单位
    ...
    static constraints = {
        invcode(nullable:false,blank:false,unique:true)
        invname(nullable:false,blank:false)
        modifytime(sqlType:'date')
    }
    static mapping = {
        cache true
    }
