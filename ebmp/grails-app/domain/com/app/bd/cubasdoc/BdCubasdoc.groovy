...
//    String ecotypesincevfive	//经济类型
    ...
    BdAreacl pkAreacl //地区分类
    BdCorp pkCorp  //公司主键
    BdCorp pkCorp1 //对应公司编码
    ...
    String sourceId
    static constraints = {
        custcode(nullable:false,blank:false,unique:true);
        custname(nullable:false,blank:false,unique:true);
        url(url: true )
    }
    static mapping = {
        sampleGuarantee(sqlType:'date')
        cache true
    }

    def defaultPart(){
        [id:id,custcode:custcode,custname:custname]
    }
