...
class BdInvmandoc {
    ...
    BdCorp  pkCorp  //公司主键
	BdCumandoc  pkCumandoc //主供应商
    BdInvbasdoc  pkInvbasdoc //存货档案主键
    String  prodArea //产地
    ...
    def defaultPart(){
        [id:id,invname:pkInvbasdoc.invname,pkInvbasdoc:[id:pkInvbasdoc.id,invname:pkInvbasdoc.invname,invcode:pkInvbasdoc.invcode,invspec:pkInvbasdoc.invspec,invtype:pkInvbasdoc.invtype,bdmeasdoc:[measname:pkInvbasdoc.bdmeasdoc.measname]]]
    }
}
