...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="name"
            sortable="true">${message(code: 'bdPsnbasdoc.name.label', default: 'Name')}</th>
        
        <th field="sex"
            sortable="true">${message(code: 'bdPsnbasdoc.sex.label', default: 'Sex')}</th>
        
        <th field="birthdate"
            sortable="true">${message(code: 'bdPsnbasdoc.birthdate.label', default: 'Birthdate')}</th>
        
        <th field="shenfenzhenghao"
            sortable="true">${message(code: 'bdPsnbasdoc.shenfenzhenghao.label', default: 'Shenfenzhenghao')}</th>
        
        <th field="addr"
            sortable="true">${message(code: 'bdPsnbasdoc.addr.label', default: 'Addr')}</th>
        
        <th field="bdCorp" sortable="false"><g:message code="bdPsnbasdoc.bdCorp.label"
                                                          default="Bd Corp"/></th>
        
        <th field="dateCreated"
            sortable="true">${message(code: 'bdPsnbasdoc.dateCreated.label', default: 'Date Created')}</th>
        
        <th field="email"
            sortable="true">${message(code: 'bdPsnbasdoc.email.label', default: 'Email')}</th>
        
        <th field="homephone"
            sortable="true">${message(code: 'bdPsnbasdoc.homephone.label', default: 'Homephone')}</th>
        
        <th field="joinworkdate"
            sortable="true">${message(code: 'bdPsnbasdoc.joinworkdate.label', default: 'Joinworkdate')}</th>
        
        <th field="lastUpdated"
            sortable="true">${message(code: 'bdPsnbasdoc.lastUpdated.label', default: 'Last Updated')}</th>
        
        <th field="mobile"
            sortable="true">${message(code: 'bdPsnbasdoc.mobile.label', default: 'Mobile')}</th>
        
        <th field="officephone"
            sortable="true">${message(code: 'bdPsnbasdoc.officephone.label', default: 'Officephone')}</th>
        
        <th field="postalcode"
            sortable="true">${message(code: 'bdPsnbasdoc.postalcode.label', default: 'Postalcode')}</th>
        
        <th field="ssnum"
            sortable="true">${message(code: 'bdPsnbasdoc.ssnum.label', default: 'Ssnum')}</th>
        
        <th field="usedname"
            sortable="true">${message(code: 'bdPsnbasdoc.usedname.label', default: 'Usedname')}</th>
