...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="bdCorp" sortable="false"><g:message code="pubBusinessType.bdCorp.label"
                                                          default="Bd Corp"/></th>
        
        <th field="code"
            sortable="true">${message(code: 'pubBusinessType.code.label', default: 'Code')}</th>
        
        <th field="dateCreated"
            sortable="true">${message(code: 'pubBusinessType.dateCreated.label', default: 'Date Created')}</th>
        
        <th field="lastUpdated"
            sortable="true">${message(code: 'pubBusinessType.lastUpdated.label', default: 'Last Updated')}</th>
        
        <th field="name"
            sortable="true">${message(code: 'pubBusinessType.name.label', default: 'Name')}</th>
