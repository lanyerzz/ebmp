...
<script>
    var fs${pageId}=[
        ...
        {key:'bdCorp.unitName',value:'${message(code:'pubBusinessType.bdCorp.unitName.label', default: 'Bd Corp')}',editerType:'text'},
        
        {key:'code',value:'${message(code:'pubBusinessType.code.label', default: 'Code')}',editerType:'text'},
        
        {key:'name',value:'${message(code:'pubBusinessType.name.label', default: 'Name')}',editerType:'text'},
    ...
    var dd${pageId}={
        ...
        {operator:'equals',fieldName:'bdCorp.unitName',defaultValue:''},
