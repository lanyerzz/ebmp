...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
       ...
       rownumbers="true"
       idField="id" treeField="invclassName" fit="true" toolbar="#tb${pageId}">
    ...
    <tr>
        ...
        <th field="invclassCode"
            sortable="true">${message(code: 'bdInvcl.invclassCode.label', default: 'Invclass Code')}</th>
        
        <th field="invclassName"
            sortable="true">${message(code: 'bdInvcl.invclassName.label', default: 'Invclass Name')}</th>
        
        <th field="forinvName"
            sortable="true">${message(code: 'bdInvcl.forinvName.label', default: 'Forinv Name')}</th>
        ...
        }">${message(code: 'bdInvcl.sealFlag.label', default: 'Seal Flag')}</th>
