...
<div id="main${pageId}" style="padding: 3px" class="easyui-panel" data-options="fit:true,border:false,noheader:true,onResize:onResize${pageId}"  >
    <div id="list${pageId}" class="easyui-panel" title=""
        ...
        <div id="tb${pageId}">
            ...
            <g:addButton billTypeCode="YZMTD" pageId="${pageId}" handler="onAdd" refHandler="onRefPage"></g:addButton>
            ...
            <a href="#" class="easyui-linkbutton" iconCls="" plain="true" iconCls="icon-check" onclick="onCheck${pageId}()">
                ${message(code: 'default.button.check.label',default: '审核')}
            </a>
            <a href="#" class="easyui-linkbutton" iconCls="" plain="true" iconCls="icon-uncheck" onclick="onUnCheck${pageId}()">
