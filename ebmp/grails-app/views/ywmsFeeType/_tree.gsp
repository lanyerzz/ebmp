...
<g:set var="entityName" value="${message(code: 'ywmsFeeType.label', default: 'YwmsFeeType')}"/>
<script>
...
<table id="table${pageId}" class="easyui-treegrid"
    ...
    <tr>
        ...
        <th field="code"
            sortable="true">${message(code: 'ywmsFeeType.code.label', default: 'Code')}</th>


        
        <th field="name"
            sortable="true">${message(code: 'ywmsFeeType.name.label', default: 'Name')}</th>
