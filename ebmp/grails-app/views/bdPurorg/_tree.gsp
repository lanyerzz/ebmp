...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="code"
            sortable="true">${message(code: 'bdPurorg.code.label', default: '采购组织编码')}</th>

        <th field="name"
            sortable="true">${message(code: 'bdPurorg.name.label', default: '采购组织名称')}</th>

        <th field="sealflag"
            sortable="true">${message(code: 'bdPurorg.sealflag.label', default: '封存标志')}</th>
