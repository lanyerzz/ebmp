            ...
            onExpandRow: function(index,row){
                $('#tb-sub${pageId}-'+index).datagrid({
                    ...
                    columns:[[
                        ...
                        {field:'nshouldoutassistNum',title:'${g.message(code:"icGeneralBody.nshouldoutassistNum.label")}'},
...
<table id="table${pageId}"
    ...
    <tr>
        ...
        <th field="billno" sortable="true" width="100">${message(code: 'icGeneralHead.billno.label', default: 'Billno')}</th>
        ...
        <th field="vnote" sortable="true" width="100">${message(code: 'icGeneralHead.vnote.label', default: 'Vnote')}</th>
        ...
        <th field="checker" sortable="true" width="100"><g:message code="icGeneralHead.checker.label" default="Checker"/></th>

        <th field="checkDate" sortable="true" data-options="formatter:dateFormate" width="100">${message(code: 'icGeneralHead.checkDate.label', default: 'Check Date')}</th>




        <th field="bdCorp.unitName" data-options="formatter:defaultFormatter" sortable="true" width="100"><g:message code="icGeneralHead.bdCorp.label" default="Bd Corp"/></th>
    </tr>
    </thead>
</table>
