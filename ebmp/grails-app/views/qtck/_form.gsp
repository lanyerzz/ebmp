...
<span  class="fieldcontain  ">
    <label for="businessType${pageId}">
        <g:message code="icGeneralHead.businessType.label" default="业务类型" />

    </label>

    <input id="businessType${pageId}" name="businessType" class="myui" value="${icGeneralHeadInstance?.businessType?.name}" disabled="" >
</span>
