...
<table id="bodyTable${pageId}"
    ...
    <tr>
        ...
        <th field="nshouldoutNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:nshouldoutNum${pageId}}}" width="80"><g:message code='icGeneralBody.nshouldoutNum.label'></g:message></th>
