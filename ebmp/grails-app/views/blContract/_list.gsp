...
<g:set var="entityName" value="${message(code: 'baseContract.label', default: 'BlContract')}"/>
<script>
...
<table id="table${pageId}" class="easyui-datagrid"
       url="${createLink(controller: 'blContract', action: 'query')}"
       rownumbers="true"
...
>
    ...
    <tr>
        ...
        <th colspan="13">货物情况</th>
        <th colspan="16">存储条款</th>
