...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="code"
            sortable="true">${message(code: 'bdBalatype.code.label', default: 'Code')}</th>

        <th field="dateCreated"
            sortable="true">${message(code: 'bdBalatype.dateCreated.label', default: 'Date Created')}</th>

        <th field="lastUpdated"
            sortable="true">${message(code: 'bdBalatype.lastUpdated.label', default: 'Last Updated')}</th>

        <th field="name"
            sortable="true">${message(code: 'bdBalatype.name.label', default: 'Name')}</th>

        <th field="sealflag"
            sortable="true">${message(code: 'bdBalatype.sealflag.label', default: 'Sealflag')}</th>
