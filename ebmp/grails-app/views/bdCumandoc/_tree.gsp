...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="cmneCode"
            sortable="true">${message(code: 'bdCumandoc.cmneCode.label', default: 'Cmne Code')}</th>
        
        <th field="dateCreated"
            sortable="true">${message(code: 'bdCumandoc.dateCreated.label', default: 'Date Created')}</th>
        
        <th field="iscustomer"
            sortable="true">${message(code: 'bdCumandoc.iscustomer.label', default: 'Iscustomer')}</th>
        
        <th field="isvender"
            sortable="true">${message(code: 'bdCumandoc.isvender.label', default: 'Isvender')}</th>
        
        <th field="lastUpdated"
            sortable="true">${message(code: 'bdCumandoc.lastUpdated.label', default: 'Last Updated')}</th>
        
        <th field="linkMan"
            sortable="true">${message(code: 'bdCumandoc.linkMan.label', default: 'Link Man')}</th>
        
        <th field="memo"
            sortable="true">${message(code: 'bdCumandoc.memo.label', default: 'Memo')}</th>
        
        <th field="mobilePhone"
            sortable="true">${message(code: 'bdCumandoc.mobilePhone.label', default: 'Mobile Phone')}</th>
        
        <th field="pkCorp" sortable="false"><g:message code="bdCumandoc.pkCorp.label"
                                                          default="Pk Corp"/></th>
        
        <th field="pkCubasdoc" sortable="false"><g:message code="bdCumandoc.pkCubasdoc.label"
                                                          default="Pk Cubasdoc"/></th>
        
        <th field="sealFlag"
            sortable="true">${message(code: 'bdCumandoc.sealFlag.label', default: 'Seal Flag')}</th>
