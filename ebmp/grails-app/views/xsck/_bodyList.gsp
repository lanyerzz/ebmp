...
<script>
    ...
    $(function(){
        ...
        <g:if test="${!bodys}">$('#bodyTable${pageId}').edatagrid('addRow');</g:if>
    ...
    function nshouldoutassistNum${pageId}(newValue, oldValue){
        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');

        var nshouldoutNum=Number(newValue)*Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'nshouldoutNum',value:nshouldoutNum});
    }


    function noutassistNum${pageId}(newValue, oldValue){
        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');
        var noutNum=Number(newValue)*Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'noutNum',value:noutNum});

    }



    function nshouldoutNum${pageId}(newValue, oldValue){

        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');
        var nshouldoutassistNum=Number(newValue)/Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'nshouldoutassistNum',value:nshouldoutassistNum});
    }

    function noutNum${pageId}(newValue, oldValue){
        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');
        var noutassistNum=Number(newValue)/Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'noutassistNum',value:noutassistNum});
    }

    function hsl${pageId}(newValue, oldValue){
        var hsl=Number(newValue);
        var noutassistNum=$('#bodyTable${pageId}').edatagrid('getColValue','noutassistNum');
        var nshouldoutassistNum=$('#bodyTable${pageId}').edatagrid('getColValue','nshouldoutassistNum');
        var noutNum=Number(noutassistNum)*hsl;
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'noutNum',value:noutNum});
        var nshouldoutNum=Number(nshouldoutassistNum)*hsl;
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'nshouldoutNum',value:nshouldoutNum});
...
<table id="bodyTable${pageId}"
    ...
    <tr>
        ...
        <g:refTemplate code="refBdInvmandoc"  inForm="false" model="[required:true,field:'bdInvmandoc',title:g.message(code: 'icGeneralBody.bdInvmandoc.label', default: '存货'),onChange:'onChangeinv'+pageId,onSelect:'onSelectinv'+pageId]"></g:refTemplate>
        ...
        <th field="hsl" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:hsl${pageId}}}" width="80"><g:message code="icgeneralbody.hsl.label" /></th>
        ...
        <th field="nshouldoutassistNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:nshouldoutassistNum${pageId}}}" width="80">
        <g:message code='icGeneralBody.nshouldoutassistNum.label'></g:message></th>

        <th field="nshouldoutNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:nshouldoutNum${pageId},onblur:nshouldoutNum${pageId}}}" width="80"><g:message code='icGeneralBody.nshouldoutNum.label'></g:message></th>

        <th field="noutassistNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:noutassistNum${pageId}}}" width="80"><g:message code='icGeneralBody.noutassistNum.label'></g:message></th>

        <th field="noutNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:noutNum${pageId}}}" width="80"><g:message code='icGeneralBody.noutNum.label'></g:message></th>
        ...
        <th field="outDate" sortable="true" editor="{type:'datebox',options:{required:true}}" width="80" data-options="formatter:dateFormate"><g:message code='icGeneralBody.outDate.label'></g:message></th>
