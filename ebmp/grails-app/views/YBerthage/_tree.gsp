...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="code"
            sortable="true">${message(code: 'YBerthage.code.label', default: 'Code')}</th>
        
        <th field="name"
            sortable="true">${message(code: 'YBerthage.name.label', default: 'Name')}</th>
        
        <th field="bdCorp" sortable="false"><g:message code="YBerthage.bdCorp.label"
                                                          default="Bd Corp"/></th>
        
        <th field="dateCreated"
            sortable="true">${message(code: 'YBerthage.dateCreated.label', default: 'Date Created')}</th>
        
        <th field="describe"
            sortable="true">${message(code: 'YBerthage.describe.label', default: 'Describe')}</th>
        
        <th field="isuse"
            sortable="true">${message(code: 'YBerthage.isuse.label', default: 'Isuse')}</th>
        
        <th field="jswz"
            sortable="true">${message(code: 'YBerthage.jswz.label', default: 'Jswz')}</th>
        
        <th field="kswz"
            sortable="true">${message(code: 'YBerthage.kswz.label', default: 'Kswz')}</th>
        
        <th field="lastUpdated"
            sortable="true">${message(code: 'YBerthage.lastUpdated.label', default: 'Last Updated')}</th>
        
        <th field="zdss"
            sortable="true">${message(code: 'YBerthage.zdss.label', default: 'Zdss')}</th>
        
        <th field="zdtbdw"
            sortable="true">${message(code: 'YBerthage.zdtbdw.label', default: 'Zdtbdw')}</th>
        
        <th field="zxss"
            sortable="true">${message(code: 'YBerthage.zxss.label', default: 'Zxss')}</th>
