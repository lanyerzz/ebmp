...
<table id="table${pageId}"  class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="changeFrom" sortable="true" data-options="formatter:function(value,row){
            return row.changeFrom.billtypename
        }
        "><g:message code="pubChangescript.changeFrom.label" default="Change From" /></th>

        <th field="changeTo" sortable="true" data-options="formatter:function(value,row){
            return row.changeTo.billtypename
        }
        "><g:message code="pubChangescript.changeTo.label" default="Change To"/></th>


        <th field="path" sortable="true">${message(code: 'pubChangescript.path.label', default: 'Path')}</th>
