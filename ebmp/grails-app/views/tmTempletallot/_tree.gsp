...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="function" sortable="false"><g:message code="tmTempletallot.function.label"
                                                          default="Function"/></th>
        
        <th field="templetType"
            sortable="true">${message(code: 'tmTempletallot.templetType.label', default: 'Templet Type')}</th>
        
        <th field="tmTemplet" sortable="false"><g:message code="tmTempletallot.tmTemplet.label"
                                                          default="Tm Templet"/></th>
        
        <th field="code"
            sortable="true">${message(code: 'tmTempletallot.code.label', default: 'Code')}</th>
        
        <th field="corp" sortable="false"><g:message code="tmTempletallot.corp.label"
                                                          default="Corp"/></th>
        
        <th field="dateCreated"
            sortable="true">${message(code: 'tmTempletallot.dateCreated.label', default: 'Date Created')}</th>
        
        <th field="isDefault"
            sortable="true">${message(code: 'tmTempletallot.isDefault.label', default: 'Is Default')}</th>
        
        <th field="lastUpdated"
            sortable="true">${message(code: 'tmTempletallot.lastUpdated.label', default: 'Last Updated')}</th>
        
        <th field="role" sortable="false"><g:message code="tmTempletallot.role.label"
                                                          default="Role"/></th>
        
        <th field="user" sortable="false"><g:message code="tmTempletallot.user.label"
                                                          default="User"/></th>
