...
<table id="table${pageId}" class="easyui-treegrid" style="width:400px;height:300px"
    ...
    <tr>
        ...
        <th field="templetCode"
            sortable="true">${message(code: 'tmTemplet.templetCode.label', default: 'Templet Code')}</th>
        
        <th field="templetName"
            sortable="true">${message(code: 'tmTemplet.templetName.label', default: 'Templet Name')}</th>
        
        <th field="corp" sortable="false"><g:message code="tmTemplet.corp.label"
                                                          default="Corp"/></th>
        
        <th field="dateCreated"
            sortable="true">${message(code: 'tmTemplet.dateCreated.label', default: 'Date Created')}</th>
        
        <th field="lastUpdated"
            sortable="true">${message(code: 'tmTemplet.lastUpdated.label', default: 'Last Updated')}</th>
        
        <th field="templetPath"
            sortable="true">${message(code: 'tmTemplet.templetPath.label', default: 'Templet Path')}</th>
        
        <th field="templetType"
            sortable="true">${message(code: 'tmTemplet.templetType.label', default: 'Templet Type')}</th>
