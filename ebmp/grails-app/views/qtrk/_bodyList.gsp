...
<script>
    ...
    function nneedinassistNum${pageId}(newValue, oldValue){
        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');

        var nshouldinNum=Number(newValue)*Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'nshouldinNum',value:nshouldinNum});
    }


    function ninassistNum${pageId}(newValue, oldValue){
        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');
        var ninNum=Number(newValue)*Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'ninNum',value:ninNum});

    }



    function nshouldinNum${pageId}(newValue, oldValue){

        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');
        var nneedinassistNum=Number(newValue)/Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'nneedinassistNum',value:nneedinassistNum});
    }

    function ninNum${pageId}(newValue, oldValue){
        var hsl=$('#bodyTable${pageId}').edatagrid('getColValue','hsl');
        var ninassistNum=Number(newValue)/Number(hsl);
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'ninassistNum',value:ninassistNum});
    }

    function hsl${pageId}(newValue, oldValue){
        var hsl=Number(newValue);
        var ninassistNum=$('#bodyTable${pageId}').edatagrid('getColValue','ninassistNum');
        var nneedinassistNum=$('#bodyTable${pageId}').edatagrid('getColValue','nneedinassistNum');
        var ninNum=Number(ninassistNum)*hsl;
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'ninNum',value:ninNum});
        var nshouldinNum=Number(nneedinassistNum)*hsl;
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'nshouldinNum',value:nshouldinNum});
...
<table id="bodyTable${pageId}"
    ...
    <tr>
        ...
        <th field="nneedinassistNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:nneedinassistNum${pageId}}}" width="80">
        <g:message code='icGeneralBody.nneedinassistNum.label'></g:message></th>

        <th field="nshouldinNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:nshouldinNum${pageId}}}" width="80"><g:message code='icGeneralBody.nshouldinNum.label'></g:message></th>

        <th field="ninassistNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:ninassistNum${pageId}}}" width="80">
            <g:message code='icGeneralBody.ninassistNum.label'></g:message></th>

        <th field="ninNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:ninNum${pageId}}}" width="80"><g:message code='icGeneralBody.ninNum.label'></g:message></th>
        ...
        <th field="inDate" sortable="true" editor="{type:'datebox',options:{required:true}}" width="80" data-options="formatter:dateFormate"><g:message code='icGeneralBody.inDate.label'></g:message></th>
