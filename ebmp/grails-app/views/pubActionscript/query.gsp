...
<script>
    var fs${pageId}=[
        ...
        {key:'scriptCode',value:'${message(code:'pubActionscript.scriptCode.label', default: 'Script Code')}',editerType:'text'},
        
        {key:'scriptName',value:'${message(code:'pubActionscript.scriptName.label', default: 'Script Name')}',editerType:'text'},
        

        
        {key:'pubBilltype.id',value:'${message(code:'pubActionscript.pubBilltype.label')}',editerType:'ref',refCode:'refPubBilltype'}
        ];
    var dd${pageId}={
        relation:'and',
        criterias:[
            
        {operator:'equals',fieldName:'scriptCode',defaultValue:''},
        
        {operator:'equals',fieldName:'scriptName',defaultValue:''},
        
        {operator:'equals',fieldName:'pubBilltype.id',defaultValue:''}
