...
<g:set var="entityName" value="${message(code: 'baseContract.label', default: 'baseContract')}" />
<script>
...
<table id="table${pageId}"  class="easyui-datagrid"
       url="${createLink(controller: 'bgContract', action: 'query')}"
       rownumbers="true"
    ...
    <thead>
    <tr>
        <th colspan="4">基本合同信息</th>
        <th colspan="14">租罐条款</th>
...
<thead>
    <tr>
        ...
        }">${message(code: 'baseContract.zygh.label', default: 'Zygh')}</th>
        ...
        <th field="zgsl" sortable="true" data-options="align:'right'">${message(code: 'baseContract.zgsl.label', default: 'Zgsl')}</th>

        <th field="rksx" sortable="true" data-options="align:'right'">${message(code: 'baseContract.rksx.label', default: 'Rksx')}</th>

        <th field="zgdj" sortable="true" data-options="align:'right'">${message(code: 'baseContract.zgdj.label', default: 'Zgdj')}</th>

        <th field="zgksrq" sortable="true" data-options="{formatter:dateFormate">${message(code: 'baseContract.zgksrq.label', default: 'Zgksrq')}</th>

        <th field="zgjsrq" sortable="true" data-options="{formatter:dateFormate">${message(code: 'baseContract.zgjsrq.label', default: 'Zgjsrq')}</th>

        <th field="clhdj" sortable="true" data-options="align:'right'">${message(code: 'baseContract.clhdj.label', default: 'Clhdj')}</th>

        <th field="clhcqdj" sortable="true" data-options="align:'right'">${message(code: 'baseContract.clhcqdj.label', default: 'Clhcqdj')}</th>

        <th field="lybzj" sortable="true" data-options="align:'right'">${message(code: 'baseContract.lybzj.label', default: 'Lybzj')}</th>

        <th field="fbzjts" sortable="true" data-options="align:'right'">${message(code: 'baseContract.fbzjts.label', default: 'Fbzjts')}</th>
