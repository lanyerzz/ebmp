...
<script>
    var fs${pageId}=[
        {key:'contractNo',value:'${message(code:'bgContract.contractNo.label', default: 'Contract No')}',editerType:'text'},

        {key:'contrantNo2',value:'${message(code:'bgContract.contrantNo2.label', default: 'Contrant No2')}',editerType:'text'},

        {key:'signAddress',value:'${message(code:'bgContract.signAddress.label', default: 'Sign Address')}',editerType:'text'},

        {key:'contractescribe',value:'${message(code:'bgContract.contractescribe.label', default: 'Contractescribe')}',editerType:'text'},

        {key:'checkType',value:'${message(code:'bgContract.checkType.label', default: 'Check Type')}',editerType:'combobox',type:'int',
            options:{valueField:'key',textField:'value',data:[{key:'0',value:'罐检方式'},{key:'1',value:'穿检方式'}],editable:'false',panelHeight:'auto'}},

        {key:'gh.id',value:'${message(code:'bgContract.zygh.label', default: 'Zygh')}',editerType:'ref',refCode:'refYBdTank'},

        {key:'myfs',value:'${message(code:'bgContract.myfs.label', default: 'Myfs')}',editerType:'combobox',type:'int',
        ...
        {key:'wflxr',value:'${message(code:'bgContract.wflxr.label', default: 'Wflxr')}',editerType:'text'},

        {key:'dflxr',value:'${message(code:'bgContract.dflxr.label', default: 'Dflxr')}',editerType:'text'},
