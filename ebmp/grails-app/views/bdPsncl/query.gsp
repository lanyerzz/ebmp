...
<script>
    var fs${pageId}=[
        ...
        {key:'code',value:'${message(code:'bdPsncl.code.label', default: 'Code')}',editerType:'text'},
        
        {key:'name',value:'${message(code:'bdPsncl.name.label', default: 'Name')}',editerType:'text'},
        
        {key:'bdCorp',value:'${message(code:'bdPsncl.bdCorp.label', default: 'Bd Corp')}',editerType:'text'},
        
        {key:'dateCreated',value:'${message(code:'bdPsncl.dateCreated.label', default: 'Date Created')}',editerType:'text'},
        
        {key:'lastUpdated',value:'${message(code:'bdPsncl.lastUpdated.label', default: 'Last Updated')}',editerType:'text'},
        
        {key:'memo',value:'${message(code:'bdPsncl.memo.label', default: 'Memo')}',editerType:'text'},
        
        {key:'pid',value:'${message(code:'bdPsncl.pid.label', default: 'Pid')}',editerType:'text'},
        
        {key:'psnclscope',value:'${message(code:'bdPsncl.psnclscope.label', default: 'Psnclscope')}',editerType:'text'},
        
        {key:'sealflag',value:'${message(code:'bdPsncl.sealflag.label', default: 'Sealflag')}',editerType:'text'},
    ...
    var dd${pageId}={
        ...
        {operator:'equals',fieldName:'psnclscope',defaultValue:''},
