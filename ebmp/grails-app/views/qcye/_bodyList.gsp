...
<script>
    ...
    function hsl${pageId}(newValue, oldValue){
        ...
        var ninNum=Number(noutassistNum)*hsl;
        $('#bodyTable${pageId}').edatagrid('setLabelValue',{field:'ninNum',value:ninNum});
...
<table id="bodyTable${pageId}"
    ...
    <tr>
        ...
        <th field="ninassistNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:ninassistNum${pageId}}}" width="80">
            <g:message code='icGeneralBody.nbalanceassistNum.label'></g:message></th>

        <th field="ninNum" sortable="true" editor="{type:'numberbox',options:{precision:2,required:true,onChange:ninNum${pageId}}}" width="80"><g:message code='icGeneralBody.balanceNum.label'></g:message></th>
