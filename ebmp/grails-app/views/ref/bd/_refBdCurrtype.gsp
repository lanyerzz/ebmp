...
<input id="${id}${pageId}"  name="${name}" data-options="
                  {
                  <g:if test="${value}">url:'${createLink(controller: 'bdCurrtype',action: 'query')}/${value}',</g:if>
                  <g:else>
                     onShowPanel:function(){
                    _onShowPanelInForm('${id}','${pageId}','${createLink(controller: 'bdCurrtype',action: 'query')}');
                                                        },
                  ...
                  idField:'id',textField:'currtypename', columns:[[
                 {field:'currtypecode',title:'${g.message(code:"bdCurrtype.currtypecode.label" ,default:"Currtypecode")  }',width:100,sortable:true},
                 {field:'currtypename',title:'${g.message(code:"bdCurrtype.currtypename.label" ,default:"Currtypename") }',width:100,sortable:true},
                 {field:'currtypesign',title:'${g.message (code:"bdCurrtype.currtypesign.label" ,default:"Currtypesign") }',width:100,sortable:true}
...
<div id="tbxx${p_pageId}">
    ...
    <a href="#" id="edit${p_pageId}"  iconCls="icon-edit" plain="true" onclick="openNode('010502'); ">
    </a>
</div>
</g:if>
<g:else>
    <th field="${field}"   sortable="false" width="100"  editor="{type:'comboxgrid',options:{
                 ...
                 mode:'remote',
                  ...
                  required:${required?:false},
                  rownumbers:true,singleSelect:true,pageSize:10,
                  idField:'id',textField:'currtypename',
                  <g:if test="${onSelect}"> onSelect:${onSelect},</g:if>
                  <g:if test="${onChange}"> onChange:${onChange},</g:if>


        onShowPanel:function(){
                       _onShowPanel('${field}','${pageId}','${createLink(controller: 'bdCurrtype',action: 'query')}');
                               },
