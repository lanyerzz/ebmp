...
<g:if test="${inForm==true}">
    ...
    <input id="${id}${pageId}"  name="${name}" data-options="
                  {
                  <g:if test="${value}">url:'${createLink(controller: 'bdCumandoc',action: 'queryAll')}/${value}',</g:if>
    <g:else>
        onShowPanel:function(){
        _onShowPanelInForm('${id}','${pageId}','${createLink(controller: 'bdCumandoc',action: 'queryAll')}');
                                    },
    ...
    <div id="tbxx${p_pageId}">
        ...
        <span>条件:</span>
        <input id="where${p_pageId}" name="name"  style="width:180px">
...
<g:else>
    ...
    <g:if test="${onChange}"> onChange:${onChange},</g:if>
        ...
        onShowPanel:function(){
                     _onShowPanel('${field}','${pageId}','${createLink(controller: 'bdCumandoc',action: 'queryAll')}');
                              },
                ...
                columns:[[
                 ...
                 formatter: function(val,row){
                   ...
                   if(value!=undefined && value!=null){
                    ...
                    return value.pkInvbasdoc.invname;
