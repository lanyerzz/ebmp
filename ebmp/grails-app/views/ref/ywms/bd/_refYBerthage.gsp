...
<input id="${id}${pageId}"  name="${name}" data-options="
                  {
                  <g:if test="${value}">url:'${createLink(controller: 'YBerthage',action: 'query')}/${value}',</g:if>
<g:else>
    onShowPanel:function(){
    _onShowPanelInForm('${id}','${pageId}','${createLink(controller: 'YBerthage',action: 'query')}');
                                    },
                 ...
                 {field:'code',title:'<g:message code="YBerthage.code.label" default="code" />',width:100,sortable:true},
                 {field:'name',title:'<g:message code="YBerthage.name.label" default="name" />',width:100,sortable:true}
...
<div id="tbxx${p_pageId}">
    ...
    <a href="#" id="edit${p_pageId}" iconCls="icon-edit" plain="true" onclick="openNode('090103'); ">
    </a>
</div>
    ...
    <th field="${field}" sortable="false" width="100" editor="{type:'comboxgrid',options:{
                 ...
                 mode:'remote',
                  ...
                  idField:'id',textField:'name',
                          onShowPanel:function(){
                _onShowPanel('${field}','${pageId}','${createLink(controller: 'YBerthage',action: 'query')}');
                                    },
                columns:[[
                {field:'code',title:'<g:message code="YBerthage.code.label" default="code" />',width:100,sortable:true},
                 {field:'name',title:'<g:message code="YBerthage.name.label" default="name" />',width:100,sortable:true}
