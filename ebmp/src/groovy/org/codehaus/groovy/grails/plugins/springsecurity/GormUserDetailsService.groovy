...
class GormUserDetailsService implements GrailsUserDetailsService {
	...
	protected Collection<GrantedAuthority> loadAuthorities(user, String username, boolean loadRoles) {
      ...
      //println springSecurityService.authentication.loginCorp+':corp'
        String corpid= userLoginCorp.get(username);
		Collection<?> userAuthorities = user.getAuthorities(corpid)
		def authorities = userAuthorities.collect {

           // println 'role...................................'+it.smRoles.roleCode+":"+it.bdCorp.unitCode
            new GrantedAuthorityImpl(it.smRoles.roleCode+'_'+it.bdCorp.id)
        }
