...
<ufinterface billtype="IC" filename="${filename}" isDebug="N" isexchange="Y" proc="add" receiver="${receiver}" replace="Y" roottag="ic_bill" sender="9999" subtype="run">
    <ic_bill id="${docid}">
        ...
        <ic_bill_head>
            ...
            <vbillcode>${hinfo.vbillcode}</vbillcode>
            ...
            <cdispatcherid>${sflb?default('')}</cdispatcherid>
			...
			<!--调拨入（出）库单出货（入库）公司主键 调拨出入库单非空字段 需要基础数据对照（公司目录）-->
            <cothercorpid></cothercorpid>
			<!--调拨入（出）库单出货（入库）库存组织主键 调拨出入库单非空字段 需要基础数据对照（库存组织）-->
            <cothercalbodyid></cothercalbodyid>
            <!--调拨入（出）库单出货（入库）仓库主键 可空字段 需要基础数据对照（仓库档案）-->
            <cotherwhid></cotherwhid>
            
			<!--调拨入（出）库单调出公司主键 调拨出入库单非空字段 需要基础数据对照（公司目录）-->
            <coutcorpid></coutcorpid>
            <!--调拨入（出）库单调出库存组织主键 调拨出入库单非空字段 需要基础数据对照（库存组织）-->
            <coutcalbodyid></coutcalbodyid>
            <!--调拨入（出）库单调出仓库主键 可空字段 需要基础数据对照（仓库档案）-->
            <coutwhid></coutwhid>
